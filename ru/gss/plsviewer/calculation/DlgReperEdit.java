...
public class DlgReperEdit extends DlgDirEdit < Reper > {
    ...
    @Action
    public void acOk() {
        if (checkFormattedTextFieldNullNoSupposed(jftfCoord1, -180.0, 180.0)) {
            return;
        }
        if (checkFormattedTextFieldNullNoSupposed(jftfCoord2, -180.0, 180.0)) {
            return;
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getResourceMap(DlgReperEdit.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setModal(true);
        setName("Form"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getActionMap(DlgReperEdit.class, this);

...
import ru.gss.plsviewer.commons.DlgParent;
...
public class DlgChart extends DlgParent {
     ...
     */
    public DlgChart(final XYDataset dataset, final String title, final String xLabel, final String yLabel, final boolean isStepPlot) {
        super();
        initComponents();
        chartTitle = title;
        chartLabelX = xLabel;
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getActionMap(DlgChart.class, this);
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getResourceMap(DlgChart.class);

...
public class DlgParameterChartEdit extends DlgDirEdit < JFreeChart > {
    ...
    public void acOk() {
        ...
        if (checkFormattedTextFieldNullNoSupposed(jftfY1, -100000.0, 100000.0)) {
            return;
        }
        if (checkFormattedTextFieldNullNoSupposed(jftfY2, -100000.0, 100000.0)) {
            return;
        }
        if (checkFormattedTextFieldNullNoSupposed(jftfY3, 0.0, 100000.0)) {
            return;
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getResourceMap(DlgParameterChartEdit.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setModal(true);
        setName("Form"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ru.gss.plsviewer.PLSViewerApp.class).getContext().getActionMap(DlgParameterChartEdit.class, this);
